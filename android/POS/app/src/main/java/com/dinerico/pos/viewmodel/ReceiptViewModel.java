...
public class ReceiptViewModel {
  ...
  //  private static final String ADICIONALES = "";
  ...
  public void createInvoice(String claveFacturacionEletronica,
    ...
    for (OrderItem item : order.getItems()) {
      ...
      invoiceItem.setPrecio(String.format(Locale.US, "%.02f", product.getPrice()));
  ...
  public void mailInvoice(MailingInvoice mailingInvoice,
                          RequestListener<InvoiceResponse> listener){
    invoiceService.mail(mailingInvoice,listener);
  }

  public String sequentialInvoice() {
    return String.valueOf(invoiceDB.getAll().size() + 1);
  }
